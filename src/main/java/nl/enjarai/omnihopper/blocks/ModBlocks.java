...
public class ModBlocks {
    ...
    // Basic Fluid Hopper
    public static final Block FLUID_HOPPER_BLOCK = register("fluid_hopper", new OxidizableFluidHopperBlock(Oxidizable.OxidationLevel.UNAFFECTED, HOPPER_SETTINGS.apply(keyOf("fluid_hopper"))));    public static final BlockEntityType<ItemOmniHopperBlockEntity> OMNIHOPPER_BLOCK_ENTITY =
    ...
    public static final Block FLUID_OMNIHOPPER_BLOCK_EXPOSED = register("exposed_fluid_omnihopper", new OxidizableFluidOmniHopperBlock(Oxidizable.OxidationLevel.EXPOSED, HOPPER_SETTINGS.apply(keyOf("exposed_fluid_omnihopper"))));    public static final BlockEntityType<FluidHopperBlockEntity> FLUID_HOPPER_BLOCK_ENTITY =
    ...
    // Open Box Block
    public static final Block OPEN_BOX_BLOCK = register("open_box", new OpenBoxBlock(WOODEN_HOPPER_SETTINGS.apply(keyOf("open_box"))));    public static final BlockEntityType<FluidOmniHopperBlockEntity> FLUID_OMNIHOPPER_BLOCK_ENTITY =
